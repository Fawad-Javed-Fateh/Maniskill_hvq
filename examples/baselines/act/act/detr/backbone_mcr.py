...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        backbone = getattr(torchvision.models, name)(
            ...
            pretrained=False, norm_layer=FrozenBatchNorm2d)  # Set pretrained=False since we load custom weights

        # Load pretrained weights for ResNet-50
        if name == "resnet50":
            state_dict = torch.load("/home/anvuong/Desktop/ManiSkill/expdata/mcr/mcr_resnet50.pth", weights_only=True)
