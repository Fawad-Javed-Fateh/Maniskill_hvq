...
def main():
    ...
    parser.add_argument(
        '--input-dir',
        type=str,
        default='/home/retrocausal-train/Desktop/Maniskill_hvq/converter/robot/good cycles',
    ...
    parser.add_argument(
        '--original-h5',
        type=str,
        default='/home/retrocausal-train/Desktop/maniskill_dataset/stack_cube/trajectory.rgbd.pd_ee_delta_pos.physx_cpu.h5',
    ...
    parser.add_argument(
        '--output-h5',
        type=str,
        default='/home/retrocausal-train/Desktop/maniskill_dataset/stack_cube/robot_stack_cube_v2.h5',
